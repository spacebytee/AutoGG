...
public class AutoGGScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int i, int j, float f) {
        ...
        guiGraphics.centeredText(Minecraft.getInstance().font, Component.literal("AutoGG Settings"), centerX, centerY-55, 0xFFFFFFFF);
        guiGraphics.text(this.font, Component.literal("GG Message"), centerX - 75, centerY - 38, 0xFFFFFFFF, true);
        guiGraphics.text(this.font, Component.literal("GG Delay (seconds)"), centerX - 75, centerY + 4, 0xFFFFFFFF,true);
    }
    public void onClose() {
